//add event handlers here
    document.getElementById("inputByIdButton").addEventListener('click',function(){
        processSearchById(document.getElementById('inputById').value);
    });

    document.getElementById("inputByTypeButton").addEventListener('click', function(){
        processSearchByType(document.getElementById('inputByType').value);
    });

    document.getElementById("inputByPriceButton").addEventListener('click', function(){
